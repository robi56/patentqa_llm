...
generation_config = {
    'max_output_tokens': 400  # Specify the maximum number of tokens to generate.
}
# def evaluate_qa_pair(question, answer, title, claim_text, abstract_text, distractors):
#     patent_text = f"{title} {abstract_text} {claim_text}"
#     prompt = f"""
#         You are an expert in evaluating QA pairs from patent texts.
        
#         Question: {question}
#         Context: {patent_text}
#         Distractors: {distractors}

#         Provide scores (1 to 10) and justifications:
#         - Groundedness
#         - Correctness
#         - Quality of Distractors
        
#         JSON Format:
#         {{"Groundedness": <score>, "Groudedness_Justification": "...",
#          "Correctness": <score>, "Correctness_Justification": "...",
#          "Quality of Distractors": <score>, "Distractor_Quality_Justification": "..."}}
#     """

#     response = client.chat.completions.create(
#         model="gpt-4o",
#         messages=[
#             {"role": "system", "content": "Evaluate QA pairs for patent texts."},
