...
generation_config = {
    'max_output_tokens': 500  # Specify the maximum number of tokens to generate.
}
...
def generate_qa_from_patent(patent_id, title, abstract, claim_text, gpt_model):
    ...
    - The correct answer
    - Three distractors (incorrect choices)
    - The context snippet from which the question was derived
...
if __name__ == "__main__":
    ...
    models=["gpt-4o", "gpt-4"]
    process_patents(csv_file_path, models[0], "gemini-test-mcq", -1)
